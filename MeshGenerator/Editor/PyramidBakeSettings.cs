...
[CreateAssetMenu(fileName = "PyramidBakeSettings", menuName ="Procedural/PyramidBakeSettings")]
public class PyramidBakeSettings : ScriptableObject
{
    ...
    [Tooltip("A scale to apply to the source mesh before generating pyramid")]
