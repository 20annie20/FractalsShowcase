        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            float GetDistanceFromDepth(float2 uv, out float3 rayDir)
            {
                ...
                // _ProjectionParams y and z are Near and Far plane distances.
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                rayDirection = mul(unity_CameraProjection, float4(rayDirection, 1.0)).xyz;
